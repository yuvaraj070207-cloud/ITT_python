...
class MenuCardSystem:
    ...
    def display_bill(self):
        ...
        print("\nTotal Amount:",total)
    def save_to_json(self, menu_file='menu.json', orders_file='orders.json'):
        # Save menu dictionary
        with open(menu_file, 'w') as mf:
           json.dump(self.menu, mf, indent=4)
	# Save orders dictionary
        with open(orders_file, 'w') as of:
           json.dump(self.orders, of, indent=4)
        print(f"Menu saved to {menu_file} and orders saved to {orders_file}")
